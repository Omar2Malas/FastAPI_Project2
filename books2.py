...
@app.get("/books") # this is the path to get all books
...
@app.get("/books/")
async def get_books_by_rating(rating_value:int):
    books_to_return = []
    for book in books :
...
def get_books_by_published_date(date : int ):
    books_to_return = []
    for book in books :
...
@app.post("/create_book") # this is the path to create a new book
